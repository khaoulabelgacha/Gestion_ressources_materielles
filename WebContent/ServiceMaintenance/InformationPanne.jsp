        ...
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <div class="layout-content">
                	...
                	<!-- [ content ] Start -->
                	<c:if test="${panne.etat eq '0' }">
                	<form action="ServletPanne" method="post">     
                        <button name="button" class="btn btn-primary pull-right" value="ajouterConstat">Ajouter Constat</button>
                  ...
                  <tr>
                   ...
                   <c:if test="${panne.etat eq '0' }"> 
                    <td>non traitée</td></c:if>
                   <c:if test="${panne.etat eq '1' }"> 
                    <td>traitée</td></c:if> 
                    <c:if test="${panne.etat eq '2' }"> 
                    <td>Decidée</td></c:if> 
